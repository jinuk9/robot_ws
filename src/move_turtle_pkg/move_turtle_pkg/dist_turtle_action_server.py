...
from move_turtle_pkg.my_subscriber import TurtlesimSubscriber
...
class DistTurtleServer(Node):
    def __init__(self):
        ...
        print('quantile_time and alomsts_time is ',quantile_time.value, almosts_time.value )
        ...
        output_msg = output_msg + "and almosts_goal_time is " + str(self.almosts_time) + ". "
